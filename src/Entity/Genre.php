...
class Genre
{
     ...
     *
     * One créé la relation inverse du ManyToOne (détenue par l'entité Books), donc
     * un genre peut avoir donc plusieur Book
     */
    private $books;
    ...
    //books est un array (grâce au constructor) donc il faut pourvoir
